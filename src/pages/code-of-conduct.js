  ...
  <Layout>
    <div className="ph3">
      <div className="measure lh-copy center">
        ...
        <p>
          All delegates, speakers, sponsors and volunteers at any DetroitJS
        ...
        <p>
          ...
          not tolerate harassment of DetroitJS participants in any form. Sexual
        ...
        <p>
          ...
          warning the offender or expulsion from the DetroitJS.
        </p>
        ...
        <p>
          Organizers:{" "}
          <a href="https://twitter.com/seafoam6" style={{ color: "black" }}>
            Steve
          </a>
          ,{" "}
          <a href="https://twitter.com/SIXLIV3" style={{ color: "black" }}>
            TJ
          </a>
        </p>
      </div>
