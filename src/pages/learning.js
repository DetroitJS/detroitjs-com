...
const legendItems = [
  ...
  {
    term: TUTORIAL_INSTALL_REQUIRED,
    description: "Interactive tutorial (installation required)"
  },
...
const learningLinks = [
  ...
  { name: "Code Combat", link: "https://codecombat.com/", symbol: GAME },
  {
    ...
    symbol: TUTORIAL_INSTALL_REQUIRED
  },
...
const LearningLink = ({ link }) => (
  <li>
    {link.symbol}{" "}
    <a className="link mid-gray dim" target="_target" href={link.link}>
      {link.name}
    </a>
  </li>
);
